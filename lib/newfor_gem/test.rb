...
# 0/5 => 2b 93 80 x26_col: 52 = row.length - 5
# 1/5 => 32 93 00 x26_col: 54 = row.length - 4
# 2/5 => 4a 93 00 x26_col: 56 = row.length - 3
# 3/5 => 60 93 80 x26_col: 60 = row.length - 2
# 4/5 => 79 93 00 x26_col: 62 = row.length - 1 
